define(['Sp','Validator','widgets/reactCheckbox/reactCheckbox','cookie'],function(Sp, Validator,ReactCheckbox,cookie){
    ...
    var Loginbox_modal = React.createClass({
                ...
                <form method="post" action="" className="form">
                    <div className="form-item">
                        <div className="form-field">
                            <input id="account" onFocus={this.showAccountTips} onKeyUp={this.checkEnter} onChange={this.checkAccount} type="text" className="form-text j-login-username" name="username" placeholder="手机号/邮箱/用户名" />
                        </div>
                        <div className="login-modal-box__error _username j-error-username u-color_red">{this.state.account.info}</div>
                    </div>
                    <div className="form-item">
                        <div className="form-field">
                            <input id="password" onFocus={this.showPassTips} onKeyUp={this.checkEnter} onChange={this.checkPass} type="password" className="form-text j-login-password" name="password" placeholder="密码" />
                        </div>
