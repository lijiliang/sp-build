...
#
#   jsx:
#   <SliderList layout imgs speed callback></SliderList>
#
...
SliderList = React.createClass
    ...
    _imgList: (item, i)->
        ...
        <div className="ui-slider-list__item" key={i} onMouseEnter={@handleMouseEnter} data-index={i}>
            <img src={item} />
        </div>
