# 模态框
define ['Sp', 'ModalBox', './verifyPhoneModalBox_tpl','./verifyPhoneModalBox_success', 'LightModalBox'], (Sp, ModalBox, verifyPhoneModalBox_tpl,verifyPhoneModalBox_success,LightModalBox)->
