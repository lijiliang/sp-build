# cart
define ['Sp','Checkbox','CheckAll','Amount_v2','PlaceSelector','./cart','./cartEmpty','LoginModalBox'], (Sp, Checkbox, CheckAll, Amount_v2, PlaceSelector, cartTpl, cartEmptyTpl, LoginModalBox)->
    Fn = ->
