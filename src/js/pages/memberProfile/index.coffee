# 商品详情页面逻辑
define ['Sp', 'SetEmailModalBox', 'SetPhoneModalBox', 'VerifyEmailModalBox', 'VerifyPhoneModalBox', 'SetPassWordModalBox','AddressList','LightModalBox','Validator'], (Sp, SetEmailModalBox, SetPhoneModalBox,VerifyEmailModalBox,VerifyPhoneModalBox, SetPassWordModalBox, AddressList, LightModalBox,Validator)->
    ...
    setEmail = () ->
        ...
        phoneNum = '<span class="u-mr_20" id="j-show-email">'+(if email then email else "尚未设置邮箱")+'</span>'
