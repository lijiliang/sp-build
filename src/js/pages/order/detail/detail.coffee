# 商品详情页面逻辑
define ['Sp','NewAddress','DatePicker','EditOrderInfoModalBox','LightModalBox','ConfirmModalBox', 'preLoad'], (Sp,NewAddress, DatePicker, EditOrderInfoModalBox, LightModalBox, ConfirmModalBox)->
